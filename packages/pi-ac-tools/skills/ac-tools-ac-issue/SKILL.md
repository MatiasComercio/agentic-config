...
**If Context Found**:
- Generate title: Summarize the issue in <60 chars
...
- STOP and prompt user:
  ...
  /skill:ac-tools-ac-issue "Title" "Description"

  Or specify type:
  /skill:ac-tools-ac-issue --bug "Brief description of the bug"
  /skill:ac-tools-ac-issue --feature "Brief description of the feature"
  ```
...
5. **Project-Agnostic Design**
   ...
   - Uses current-checkout metadata when available and otherwise falls back cleanly to `Unknown` version reporting
